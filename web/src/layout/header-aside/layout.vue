<template>
	<div class="d2-layout-header-aside-group" :style="styleLayoutMainGroup" :class="{ grayMode: grayActive }">
		...
		<div class="d2-layout-header-aside-content" flex="dir:top">
			<!-- 顶栏 -->
			<div class="d2-theme-header" :style="{ opacity: this.searchActive ? 0.5 : 1, height:'30px' }" flex-box="0" flex>
				<!-- <router-link
          to="/index"
				...
				<div class="d2-theme-container-main" flex-box="1" flex>
					...
					<transition name="fade-scale">
						<div v-if="!searchActive" class="d2-theme-container-main-layer" flex="dir:top">
							<!-- tab -->
							<div class="d2-theme-container-main-header" flex-box="0" :style="{height:'30px'}">
								<d2-tabs />
